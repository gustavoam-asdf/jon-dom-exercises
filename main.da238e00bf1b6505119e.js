...
var MenuButton = /** @class */ (function () {
    ...
    MenuButton.prototype.clickEvent = function (_a) {
        ...
        (_b = panel.self) === null || _b === void 0 ? void 0 : _b.classList.toggle('hide');
    };
...
var MenuList = /** @class */ (function () {
    ...
    MenuList.prototype.clickEvent = function (_a) {
        var icon = _a.icon, panel = _a.panel;
...
var Panel = /** @class */ (function () {
    ...
    Panel.prototype.clickEvent = function (evt) {
        var clickOnButton = evt.target.matches("#" + components_MenuButton.id) ||
            evt.target.matches("#" + components_MenuButton.id + " *");
        if (clickOnButton) {
            this.button.clickEvent({ panel: this });
        }
        var clickOnMenuItem = evt.target.matches("#" + components_MenuList.id + " *");
        if (clickOnMenuItem) {
