/******/ ;(() => {
  ...
  /* harmony default export */ const components_Header = Header // CONCATENATED MODULE: ./src/elementIds.ts
  ...
  var MenuButton = /** @class */ (function () {
    ...
    MenuButton.prototype.clickEvent = function () {
      ...
      ;(_a = document.getElementById(elementIds.panel.menu.self)) === null ||
      _a === void 0
        ? void 0
        : _a.classList.toggle("hide")
    }
  ...
  var panelClickEvent = function (evt) {
    ...
    var clickOnMenuItem = evt.target.matches(
      "#" + elementIds.panel.menu.list + " *"
    )
    if (clickOnMenuItem) {
      changeIcon()
      ;(_b = document.getElementById(elementIds.panel.menu.self)) === null ||
      _b === void 0
        ? void 0
